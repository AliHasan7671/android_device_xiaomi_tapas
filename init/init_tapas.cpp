...
void load_redmi_properties(string hwname) {
    ...
    if (hwname == "tapas") {
        ...
        fingerprint = "Redmi/tapas_global/tapas:13/TKQ1.221114.001/V816.0.8.0.UMTMIXM:user/release-keys";
        description = "tapas_global-user 13 TKQ1.221114.001 V816.0.8.0.UMTMIXM release-keys";
        ...
        description = "tapas_global-user 13 TKQ1.221114.001 V816.0.6.0.UMGMIXM release-keys";
    }
